...
public class ModelGenerator extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators generators) {
        ...
        generators.delegateItemModel(ModBlocks.TOWER_HEAD, getModelLocation(ModBlocks.TOWER_HEAD));
        generators.delegateItemModel(ModBlocks.ANTENNA, getModelLocation(ModBlocks.ANTENNA));
