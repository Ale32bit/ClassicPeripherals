...
public class Crypto {
    ...
    public String encryptAes(String data, String key, String iv) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
    ...
    public String decryptAes(String data, String key, String iv) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        var keyBytes = key.getBytes(CHARSET);
        var ivBytes = iv.getBytes(CHARSET);
        var dataBytes = data.getBytes(CHARSET);
